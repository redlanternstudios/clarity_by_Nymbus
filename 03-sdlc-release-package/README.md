...
This workspace folder is the source draft for the reusable `/sdlc` skill and the Clarity by Nymbus release package.
...
Keep the skill generic. Keep the Clarity package specific. Keep both lean.
